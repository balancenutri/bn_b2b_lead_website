export const bnShopDetails = {
  benefits: [
    ...
    {
      title: "2. Nutrition-Led Product Validation",
      points: [
        "Ingredients are checked and validated by khyati and 20+ clinical nutritionists team",
        "Labels are made clear, honest, and fully compliant",
      ],
    },
    {
      title: "3. Packaging & Trust Building",
      points: [
        "Products are shown as nutritionist approved",
        "Clear “what you see is what you get” positioning",
      ],
    },
    {
      title: "4. Marketing & Proof of Use",
      points: [
        "Social media promotions",
        "Education based content",
        "Trust focused brand communication",
      ],
    },
    {
      ...
      points: [
        "Products are directly added to BN diet plans",
        "This builds strong medical and nutrition trust",
      ],
    },
    {
      title: "6. Real Market Testing",
      points: [
        "Honest feedback from paying BN clients",
        "Easy changes in product based on real usage",
      ],
    },
    {
      title: "7. Distribution Through Balance Nutrition Network",
      points: [
        "Products are recommended through BN app and nutritionists",
        "Products can be placed in BN franchise centres",
        "Opportunities in corporate nutrition programs",
      ],
    },
  ],
  checklist: {
    who: "For manufacturers, willing to operate with full transparency, and focused on long-term brand building rather than quick flips.",
    requirements: [
      {
        title: "Product Flexibility",
        desc: "Openness to formulation, ingredient, or label innovations. Final nutritional decisions are guided by BN standards.",
      },
      {

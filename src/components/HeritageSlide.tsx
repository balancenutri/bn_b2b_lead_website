  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-16 md:mb-20 max-w-4xl mx-auto">
        ...
        >
          Leadership built on{" "}
          <span className="font-medium text-teal-deep">business acumen</span>{" "}
          and{" "}
          <span className="font-medium text-teal-deep">clinical expertise</span>
          , validated by the world's most trusted brands.
        </motion.p>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <div className="flex flex-row items-start gap-6 mb-6">
              ...
              <div className="w-24 h-24 md:w-28 md:h-28 rounded-2xl overflow-hidden border border-teal-base/20 group-hover:border-teal-base transition-colors shrink-0 shadow-sm relative bg-teal-deep/5">
                <img
                  ...
                  onError={(e) => {
                    ...
                    target.src =
                      "https://ui-avatars.com/api/?name=Vishal+Rupani&background=0E5858&color=fff&size=256";
                  }}
                  alt="Vishal Rupani"
              ...
              <div className="pt-2">
                <h2 className="font-serif text-2xl text-teal-deep leading-tight">
                  Vishal Rupani
                </h2>
                <p className="text-xs uppercase tracking-widest text-teal-deep/50 font-bold mt-2 mb-3">
                  Founder & CEO
                </p>
              </div>
            </div>
            <p className="text-teal-deep/70 font-sans leading-relaxed text-sm mb-6">
              Former CEO of Talwalkars and Fitness First. Brings over{" "}
              <span className="font-bold text-teal-deep">
                28 years of experience
              </span>{" "}
              in fitness and wellness. A fitness enthusiast who practices
              functional training and runs 10km, he combines financial expertise
              with a passion for scalable health tech.
            </p>
            <div className="flex flex-wrap gap-2">
              <span className="px-3 py-1 bg-teal-base/10 text-teal-deep text-xs font-bold rounded-full">
                Business Strategy
              </span>
              <span className="px-3 py-1 bg-teal-base/10 text-teal-deep text-xs font-bold rounded-full">
                Scalable Tech
          ...
          >
            ...
            <p className="text-teal-deep/70 font-sans leading-relaxed text-sm mb-6">
              Clinical nutritionist with nearly two decades of experience.
              Became{" "}
              <span className="font-bold text-teal-deep">
                Lilavati Hospital’s Chief Nutritionist at 22
              </span>
              . Author of "Getting Rid of Obesity" and the architect of BN's
              clinical protocols, inspired by her own victory over PCOS.
            </p>
            <div className="flex flex-wrap gap-2">
              <span className="px-3 py-1 bg-teal-base/10 text-teal-deep text-xs font-bold rounded-full">
                Clinical Excellence
        ...
        <div className="relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-16 relative">
            ...
            <div className="relative group">
              <div className="absolute -top-10 -left-4 text-8xl font-serif text-warmYellow opacity-20 transform -translate-x-2 group-hover:translate-x-0 transition-transform duration-700">
                “
              </div>
              <blockquote className="relative z-10 font-serif text-2xl md:text-3xl leading-snug text-white/95 mb-8">
                "Khyati possesses a unique blend of expertise in diet and food a
                rare combination. She is detailed, meticulous, and{" "}
                <span className="text-warmYellow/90 italic">
                  highly attuned
                </span>{" "}
                to the audience she serves."
              </blockquote>
              <div className="flex items-center gap-4 pl-2 border-l-2 border-warmYellow/50">
                <div>
                  ...
                  <div className="font-sans text-white/60 text-xs uppercase tracking-wider mt-1">
                    Chairman - IIFL Group
                  </div>
                </div>
              </div>
            ...
            <div className="relative group">
              ...
              <blockquote className="relative z-10 font-serif text-2xl md:text-3xl leading-snug text-white/95 mb-8">
                "My productivity at work has increased, leading to new
                opportunities. Khyati's approach goes beyond food; she{" "}
                <span className="text-warmYellow/90 italic">
                  empowers people
                </span>{" "}

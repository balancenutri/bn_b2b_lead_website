...
const TeamStat = ({ count, role, desc, delay }: { count: string, role: string, desc: string, delay: number }) => (
  <motion.div 
    ...
    className="flex flex-col items-center text-center p-6 md:p-8 bg-white/50 rounded-[2rem] border border-teal-deep/5 hover:bg-white hover:shadow-lg transition-all duration-300 group h-full justify-start w-full"
  >
